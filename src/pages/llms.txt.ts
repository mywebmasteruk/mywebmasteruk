...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "## Core pages",
    "",
    `- [How Autopilot works](${site.url}/how-it-works/): The four-phase cycle — measure daily, decide weekly, ship one change per commit, then give each changed page 28 days to settle before it is changed again.`,
    ...
    `- [Proof and method](${site.url}/proof/): The published baseline, this site's real speed, and what can and cannot be claimed yet.`,
